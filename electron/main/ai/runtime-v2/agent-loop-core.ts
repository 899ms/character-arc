 ...
 */
export class AgentLoopCore {
  private readonly conversation: ConversationManager
  private readonly staged: StagedChangesStore
  private readonly emit: EventEmitter
  private readonly runAgentImpl: RunAgentImpl
  private readonly isToolUseNotSupportedError: ToolUseErrorClassifier
  ...
  constructor(
    ...
    isToolUseNotSupportedError: ToolUseErrorClassifier
  ) {
    this.conversation = conversation
    this.staged = staged
    this.emit = emit
    this.runAgentImpl = runAgentImpl
    this.isToolUseNotSupportedError = isToolUseNotSupportedError
  }
